...
class Pessoa:
    ...
    def __init__(self, nome="", email="", tel=Celular):
        self.nome = nome
        self.email = email
        self.telefone = tel
...
if __name__ == "__main__":
    ...
    marlete = Pessoa("Marlete de Andrade da Silva", "marlete@gmail.com", Celular("123456", "xpto", "tim"))
